...
const marvelSchema = {
    ...
    required: ["id", "name", "description", "modified", "thumbnail", "resourceURI", "comics", "series", "stories", "events", "urls"],
    properties: {
        id: {
            type: "number",
        },
...
console.log(ajv.validateSchema(marvelSchema));
console.log(JSON.stringify(marvelSchema, null, 4));

const objectCard = {
    id: 1009368,
    name: "Iron Man",
    description: "Wounded, captured and forced to build a weapon by his enemies, " +
        "billionaire industrialist Tony Stark instead created an advanced suit of armor " +
        "to save his life and escape captivity. Now with a new outlook on life, Tony uses " +
    ...
    urls: [
        {
            type: "detail",
            url: "http://marvel.com/comics/characters/1009368/iron_man?utm_campaign=apiRef&utm_source=be105ab34ee223ae2b4c2f09d92340b6"
        },
        {
            type: "wiki",
            url: "http://marvel.com/universe/Iron_Man_(Anthony_Stark)?utm_campaign=apiRef&utm_source=be105ab34ee223ae2b4c2f09d92340b6"
        },
        {
            type: "comiclink",
            url: "http://marvel.com/comics/characters/1009368/iron_man?utm_campaign=apiRef&utm_source=be105ab34ee223ae2b4c2f09d92340b6"
...
const validate = ajv.compile(marvelSchema);
