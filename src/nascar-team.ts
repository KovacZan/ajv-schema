...
console.log(ajv.validateSchema(nascarTeamSchema));
console.log(JSON.stringify(nascarTeamSchema, null, 4));

// const objectCard = {
//     teamName: "CHIP GANASSI RACING TEAM",
//     description: "Chip Ganassi Racing has been fielding entries in NASCAR since 1989. " +
//         "As a team, they have a total of 24 wins in the Cup Series and 22 in the Xfinity Series." +
//         " Car numbers they have run include the 1, 40, 41, & 42. Notable drivers that have run under " +
//         "the team's banner include Kyle Petty, Joe Nemechek, Jimmy Spencer, Jamie McMurray, Sterling Marlin " +
...
const objectCard = {
    ...
    description: "Front Row Motorsports came into NASCAR full-time in 2005. " +
        "They began part-time in 2004 as Means-Jenkins Motorsports. " +
        "The team currently has a technical alliance with Roush Fenway Racing " +
        "and also has received support from Ford since 2016. They fielded primarily " +
        "two cars for a majority of their time in NASCAR and then were awarded the assets " +
        "from BK Racing in 2018 to field a third car. They have used car numbers such as 34, 35," +
        " 36, 37, 38, and 55. They have competed in 898 Cup Series races and 75 Xfinity Series races. " +
        "The team has two victories in 2013 and 2016.",
    carType: "Ford",
    drivers: [
        {
            name: "Todd Gilliland",
...
// };
const validate = ajv.compile(nascarTeamSchema);
